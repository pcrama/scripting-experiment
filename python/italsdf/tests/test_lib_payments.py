...
class GetPaymentsData(unittest.TestCase):
    def test_examples(self):
        SEL_FROM = 'SELECT id,timestamp,amount_in_cents,comment,uuid,user,ip FROM payments'
    ...
    def test_integration(self):
        ...
        for params, expected in (
                ((1, None, None, None),
                 [{'amount_in_cents': 3, 'comment': 'unit test comment', 'id': 1, 'timestamp': 2.5}]),
                ((2, None, None, None),
                 [{'amount_in_cents': 3, 'comment': 'unit test comment', 'id': 1, 'timestamp': 2.5},
                  {'amount_in_cents': 4, 'comment': 'other unit test comment', 'id': 2, 'timestamp': 5.0}]),
                ((3, None, None, None),
                 [{'amount_in_cents': 3, 'comment': 'unit test comment', 'id': 1, 'timestamp': 2.5},
                  {'amount_in_cents': 4, 'comment': 'other unit test comment', 'id': 2, 'timestamp': 5.0},
                  {'amount_in_cents': 2, 'comment': None, 'id': 29, 'timestamp': 98.0}]),
                ((0, "unit", None, None),
                 []),
                ((3, "unit", None, None),
                 [{'amount_in_cents': 3, 'comment': 'unit test comment', 'id': 1, 'timestamp': 2.5},
                ...
                ((3, "unit", 1, None),
                 [{'amount_in_cents': 4, 'comment': 'other unit test comment', 'id': 2, 'timestamp': 5.0}]),
                ((5, None, 3, 10),
                 [{'amount_in_cents': 6, 'comment': 'Auto comment 2', 'id': 30, 'timestamp': 102.5},
                  {'amount_in_cents': 4, 'comment': 'Auto comment 4', 'id': 32, 'timestamp': 100.5},
                  {'amount_in_cents': 10, 'comment': None, 'id': 33, 'timestamp': 94.0},
                  {'amount_in_cents': 28, 'comment': None, 'id': 35, 'timestamp': 92.0},
                  {'amount_in_cents': 8, 'comment': 'Auto comment 8', 'id': 36, 'timestamp': 96.5}]),
        ):
