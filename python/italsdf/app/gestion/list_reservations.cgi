        ...
        respond_html(html_document(
            ...
            (('p',
             ...
             (('form', 'method', 'post', 'action', 'add_unchecked_reservation.cgi'),
              ...
              (('input', 'id', 'places', 'name', 'places', 'type', 'number', 'min', '1', 'value', '1'),),
              ('br',),
              (('input', 'id', 'samedi', 'name', 'date', 'type', 'hidden', 'value', '2022-03-19'),),
              ('br',),
              (('label', 'for', 'outside_fondus'), 'Fondus:'),
              (('input', 'id', 'outside_fondus', 'name', 'outside_fondus', 'type', 'number', 'min', '0', 'value', '0'),),
              ('br',),
              (('label', 'for', 'outside_assiettes'), 'Assiettes de charcuterie:'),
              (('input', 'id', 'outside_assiettes', 'name', 'outside_assiettes', 'type', 'number', 'min', '0', 'value', '0'),),
              ('br',),
              (('label', 'for', 'outside_bolo'), 'Spaghettis Bolognaise:'),
              (('input', 'id', 'outside_bolo', 'name', 'outside_bolo', 'type', 'number', 'min', '0', 'value', '0'),),
              ('br',),
              (('label', 'for', 'outside_scampis'), 'Spaghettis aux Scampis:'),
              (('input', 'id', 'outside_scampis', 'name', 'outside_scampis', 'type', 'number', 'min', '0', 'value', '0'),),
              ('br',),
              (('label', 'for', 'outside_tiramisu'), 'Tiramisu:'),
              (('input', 'id', 'outside_tiramisu', 'name', 'outside_tiramisu', 'type', 'number', 'min', '0', 'value', '0'),),
              ('br',),
              (('label', 'for', 'outside_tranches'), 'Tranche Napolitaine:'),
              (('input', 'id', 'outside_tranches', 'name', 'outside_tranches', 'type', 'number', 'min', '0', 'value', '0'),),
              ('br',),
