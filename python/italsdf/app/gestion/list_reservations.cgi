        ...
        respond_html(html_document(
            ...
            (('p',
             ...
             (('form', 'method', 'post', 'action', 'add_unchecked_reservation.cgi'),
              ...
              (('input', 'id', 'places', 'name', 'places', 'type', 'number', 'min', '0', 'value', '1'),),
              ('br',),
              (('input', 'id', 'samedi', 'name', 'date', 'type', 'radio', 'value', '2022-03-19',
                'checked', 'checked'),),
              (('label', 'for', 'samedi'), 'Samedi 19 mars 2022 à 18h30 (portes ouvertes dès 17h30)'),
              ('br',),
              (('input', 'id', 'dimanche', 'name', 'date', 'type', 'radio', 'value', '2022-03-20'),),
              (('label', 'for', 'dimanche'), 'Dimanche 20 mars 2022 à 12h'),
              ('br',),
              (('label', 'for', 'fondus'), 'Fondus:'),
              (('input', 'id', 'fondus', 'name', 'fondus', 'type', 'number', 'min', '0', 'value', '0'),),
              ('br',),
              (('label', 'for', 'assiettes'), 'Assiettes de charcuterie:'),
              (('input', 'id', 'assiettes', 'name', 'assiettes', 'type', 'number', 'min', '0', 'value', '0'),),
              ('br',),
              (('label', 'for', 'bolo'), 'Spaghettis Bolognaise:'),
              (('input', 'id', 'bolo', 'name', 'bolo', 'type', 'number', 'min', '0', 'value', '0'),),
              ('br',),
