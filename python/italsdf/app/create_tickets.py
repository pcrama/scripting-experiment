                ...
                *itertools.chain(
                    *(x
                      for x in (
                              ...
                              in (('entrée:', EXTRA_STARTER_NAME, extra_starter, EXTRA_STARTER_IMAGE),
                                  ('entrée:', MAIN_STARTER_NAME, main_starter, MAIN_STARTER_IMAGE),
...
def create_tickets_for_one_reservation(r):
    inside_dessert = r.inside_bolo + r.inside_extra_dish
    kids_dessert = r.kids_bolo + r.kids_extra_dish
    total_tickets = (
        ...
        r.outside_dessert + inside_dessert + kids_dessert)
    ticket_details = ', '.join(
        ...
        outside, inside, kind in (
            ...
            (r.outside_dessert, inside_dessert + kids_dessert, DESSERT_NAME))
    ...
    return (
        ...
        if total_tickets == 0
              ...
              _ticket_table(
                  ...
                  dessert=r.outside_dessert + inside_dessert + kids_dessert)))
