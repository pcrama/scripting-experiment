                    ...
                    *(x
                      for x in (
                              ...
                              in (('entrée:', MAIN_STARTER_NAME, main_starter, MAIN_STARTER_IMAGE),
                                  ...
                                  ('plat:', MAIN_DISH_NAME, main_dish, MAIN_DISH_IMAGE),
                                  ('plat:', EXTRA_DISH_NAME, extra_dish, EXTRA_DISH_IMAGE),
                                  ('plat:', THIRD_DISH_NAME, third_dish, THIRD_DISH_IMAGE),
                                  ('plat enfant:', KIDS_MAIN_DISH_NAME, kids_main_dish, KIDS_MAIN_DISH_IMAGE),
                                  ('plat enfant:', KIDS_EXTRA_DISH_NAME, kids_extra_dish, KIDS_EXTRA_DISH_IMAGE),
                                  ('plat enfant:', KIDS_THIRD_DISH_NAME, kids_third_dish, KIDS_THIRD_DISH_IMAGE),
                                  ('dessert:', MAIN_DESSERT_NAME, main_dessert, MAIN_DESSERT_IMAGE),
                                  ('dessert:', EXTRA_DESSERT_NAME, extra_dessert, EXTRA_DESSERT_IMAGE)))))))
