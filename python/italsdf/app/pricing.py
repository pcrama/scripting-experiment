...
CENTS_STARTER = 900
CENTS_MAIN_DISH = 1200
CENTS_THIRD_DISH = CENTS_EXTRA_DISH = CENTS_MAIN_DISH + 500
CENTS_DESSERT = 600
CENTS_MENU_MAIN_DISH = CENTS_STARTER + CENTS_MAIN_DISH + CENTS_DESSERT - 200
CENTS_MENU_EXTRA_DISH = CENTS_STARTER + CENTS_EXTRA_DISH + CENTS_DESSERT - 200
CENTS_MENU_THIRD_DISH = CENTS_STARTER + CENTS_THIRD_DISH + CENTS_DESSERT - 200
CENTS_KIDS_MENU_MAIN_DISH = CENTS_MENU_MAIN_DISH - CENTS_STARTER
CENTS_KIDS_MENU_EXTRA_DISH = CENTS_KIDS_MENU_MAIN_DISH + (CENTS_EXTRA_DISH - CENTS_MAIN_DISH)
CENTS_KIDS_MENU_THIRD_DISH = CENTS_MENU_THIRD_DISH - CENTS_STARTER
